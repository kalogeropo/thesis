...
if __name__ == '__main__':
    ...
    for cluster_size in cluster_sizes:
        for coeff in edge_coeffs:
            ...
            con_gsb_model = ConGSBWindow(col, clusters=cluster_size, window=7, cond={'edge': 2.5*coeff}).fit(queries)
    ...
    writer.write_to_excel(sheet_name='cw-graph-clusters-avg', dataframe=experiment)